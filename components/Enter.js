  ...
  return (
    <div className="flex justify-start">
      <Link href={`/Countries/Palestine`}>
        <h1
          className="inline-flex cursor-pointer before:bg-clip-text after:bg-clip-text hover:before:w-0 hover:text-orange-500 text-transparent relative before:w-[100%] before:h-full
